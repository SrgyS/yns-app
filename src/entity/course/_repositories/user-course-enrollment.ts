...
export class UserCourseEnrollmentRepository {
  ...
  async createEnrollment(params: CreateUserCourseEnrollmentParams): Promise<UserCourseEnrollment> {
    try {
  ...
  async getEnrollment(userId: string, courseId: string): Promise<UserCourseEnrollment | null> {
    try {
  ...
  async getEnrollmentById(enrollmentId: string): Promise<UserCourseEnrollment | null> {
    try {
      const enrollment = await dbClient.userCourseEnrollment.findUnique({
