...
export function WorkoutDaySelector({
  ...
  return (
    <div className="space-y-6 p-4 border rounded-lg shadow-sm bg-card">
      <h2 className="text-xl font-semibold text-center">Выберите дни тренировок</h2>
      ...
      <div className="flex flex-wrap justify-center gap-4">
        {Object.values(DayOfWeek).map(day => (
          <DayItem day={day} today={today} maxDays={maxDays} key={day} selectedDays={selectedDays} onToggle={handleDayToggle} />
        ))}
      </div>
