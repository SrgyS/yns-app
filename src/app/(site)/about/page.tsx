        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-3">
            <Button asChild className="rounded-2xl">
              <Link href="https://t.me/dominadara">Записаться на консультацию</Link>
            </Button>
          </div>
        </div>
        ...
        <Card className="rounded-4xl bg-background/80 shadow-sm">
          <CardContent className="space-y-4 p-6 sm:p-8">
            <p>
              ...
              здоровья, питания и фитнеса. Я стремлюсь помогать людям в достижении
              их целей в области здоровья и хорошего самочувствия с помощью
              индивидуальных планов и рекомендаций.
            </p>
            <p>
              ...
              понимание человеческого тела и того, как оно работает, и я использую
              эти знания для создания индивидуальных рекомендаций для каждого из
              моих клиентов.
            </p>
            <p>
              Мои услуги включают индивидуальные консультации, онлайн-коучинг и
              поддержку, чтобы вы могли оставаться на правильном пути и достигать
              своих целей, где бы вы ни находились. Вместе сделаем вас здоровее и
              счастливее!
            </p>
          </CardContent>
        </Card>
