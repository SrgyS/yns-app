          ...
          <div className="space-y-6">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                пользователем и платформой YanaSporte в отношении использования
                сервиса и связанных с ним услуг.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                YanaSporte предоставляет платформу для обучения спортивному
                питанию, включая курсы, рецепты, практические материалы и знания
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Для доступа к полному функционалу сервиса требуется регистрация.
                Вы несете ответственность за сохранность своих учетных данных и
                за все действия, совершенные под вашим аккаунтом.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                нарушения прав других пользователей или распространения
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Мы обязуемся защищать вашу личную информацию в соответствии с
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Мы оставляем за собой право изменять настоящее соглашение. О
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                к нам через контактную форму на сайте или по электронной почте.
              </p>
            </section>
          </div>
        </CardContent>
